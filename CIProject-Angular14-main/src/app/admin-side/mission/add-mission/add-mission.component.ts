...
export class AddMissionComponent implements OnInit {
  ...
  async OnSubmit() {
    this.formValid = true;
    let imageUrl: any[] = [];
    let missionDetail = this.addMissionForm.value;
    ...
    console.log(missionDetail.missionSkillName);
    
    missionDetail.missionSkillId = Array.isArray(missionDetail.missionSkillId) ? missionDetail.missionSkillId.join(',') : missionDetail.missionSkillId;
    if (this.addMissionForm.valid) {
      ...
      missionDetail.missionImages = imgUrlList;
      ...
      this.service.AddMission(missionDetail).subscribe((data: any) => {
